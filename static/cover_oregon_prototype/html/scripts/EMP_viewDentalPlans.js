       ...
       var products = [                     
                     {"id":"1","annualmax":750,"premium":40,"image":"images/family_bkgr-01.png","sm_image":"images/family_sm-01.png","planName":"Dollar-Based Dental","hospital":"50","deductible":0,"copay":20,"carrier":"Family Insurance","plantype":"DHMO"} 
                     ,{"id":"2","annualmax":750,"premium":46,"image":"images/family_bkgr-01.png","sm_image":"images/family_sm-01.png","planName":"Incentive 10 Dental","hospital":"50","deductible":50,"copay":20,"carrier":"Family Insurance","plantype":"PPO"} 
                     ,{"id":"3","annualmax":1000,"premium":57,"image":"images/heart_bkgr-01.png","sm_image":"images/heart_sm-01.png","planName":"Dental Value","hospital":"20","deductible":50,"copay":20,"carrier":"ABC Corp","plantype":"DHMO"} 
                     ,{"id":"4","annualmax":1500,"premium":62,"image":"images/onemore_bkgr-01.png","sm_image":"images/onemore_sm-01.png","planName":"Individual 401","hospital":"20","deductible":50,"copay":20,"carrier":"OneMore Co","plantype":"PPO"} 
                     ,{"id":"5","annualmax":1500,"premium":73,"image":"images/exampleco_bkgr-01.png","sm_image":"images/exampleco_sm-01.png","planName":"Individual 501","hospital":"40","deductible":50,"copay":15,"carrier":"ExampleCo","plantype":"PPO"} 
                     ,{"id":"6","annualmax":1500,"premium":80,"image":"images/exampleco_bkgr-01.png","sm_image":"images/exampleco_sm-01.png","planName":"Individual 201","hospital":"20","deductible":50,"copay":20,"carrier":"ExampleCo","plantype":"PPO"} 
                     ,{"id":"7","annualmax":1000,"premium":90,"image":"images/family_bkgr-01.png","sm_image":"images/family_sm-01.png","planName":"Bay Care","hospital":"0","deductible":50,"copay":0,"carrier":"Family Insurance","plantype":"DHMO"} 
                     ,{"id":"8","annualmax":1000,"premium":100,"image":"images/onemore_bkgr-01.png","sm_image":"images/onemore_sm-01.png","planName":"Apex","hospital":"50","deductible":50,"copay":5,"carrier":"OneMore Co","plantype":"PPO"} 
                     ,{"id":"9","annualmax":2000,"premium":102,"image":"images/exampleco_bkgr-01.png","sm_image":"images/exampleco_sm-01.png","planName":"Dental Ind 101 ","hospital":"20","deductible":100,"copay":20,"carrier":"ExampleCo","plantype":"PPO"} 
                     ,{"id":"10","annualmax":1500,"premium":116,"image":"images/exampleco_bkgr-01.png","sm_image":"images/exampleco_sm-01.png","planName":"Individual 301","deductible":50,"copay":20,"carrier":"ExampleCo","plantype":"PPO"} 
                     ,{"id":"11","annualmax":1000,"premium":136,"image":"images/heart_bkgr-01.png","sm_image":"images/heart_sm-01.png","planName":"Ridge","hospital":"80","deductible":100,"copay":20,"carrier":"ABC Corp","plantype":"DHMO"} 
                     ,{"id":"12","annualmax":1000,"premium":140,"image":"images/heart_bkgr-01.png","sm_image":"images/heart_sm-01.png","planName":"Bay","hospital":"50","deductible":50,"copay":50,"carrier":"ABC Corp","plantype":"PPO"} 
                     ,{"id":"13","annualmax":1000,"premium":224,"image":"images/heart_bkgr-01.png","sm_image":"images/heart_sm-01.png","planName":"Dental Premier","hospital":"20","deductible":100,"copay":20,"carrier":"ABC Corp","plantype":"DHMO"} 
	...
	$.each(products, function(i, object) {   
        ...
        $.each(pageProducts, function(i, object) {  
            ...
            setpremiumRange(parseFloat(object.premium)); 
                ...
                cell += '<p>Annual max <span> &#36;'+object.annualmax+'<\/p>';
                cell += '<p>Deductible <span> &#36;'+object.deductible+'<\/p>';
                cell += '<p>Office visit <span> '+object.copay+'<\/p>';
                cell += '<p>Providers <span> N/A<\/p>';
               
                cell += '<\/div><\/div>';
                cell += '<div class="planHorizontalBoxColumn">';
                cell += '<a class="button utilityButton" href="EMP_dental_plan_details.html&#63;planid&#61;'+object.id+'">View Details</a>';
                cell += '<\/div>'
                cell += '<\/td>'; 
...
// start adding in deductible slider fundtion similar to premium range slider
  ...
  function deductibleRangeSlider(){
        $( "#deductibleDentalSlider" ).slider({  
            ...
            slide: function( event, ui ) {
                ...
                //$( "#deductibleDentalAmount" ).html( "&#36;" +ui.values[ 0 ] + " -  &#36;" + ui.values[ 1 ] );
            }
            ,stop: function(event, ui) { 
        ...
        // update the html for the slider value before its changes  
        $( "#deductibleDentalAmount" ).val( "$" + $( "#deductibleDentalSlider" ).slider( "values", 0 ) + " - $" + $( "#deductibleDentalSlider" ).slider( "values", 1 ) );
  ...
  function setAMXRange(amx){
        // find min and max AMX range   
        if(maxAMX<amx){
            maxAMX = amx;
        }  
        if(minAMX>amx){
    ...
    // deductible range animation slider
    function AMXRangeSlider(){
          $( "#annualMaxDentalSlider" ).slider({  
              range: true,
              min: 0,
              max: maxAMX,
              values: [ minAMX, maxAMX ],
              slide: function( event, ui ) {
                  // update the html for the slider value
                          $( "#annualMaxDentalAmount" ).val( "$" + ui.values[ 0 ] + " - $" + ui.values[ 1 ] );
                  //$( "#annualMaxDentalAmount" ).html( "&#36;" +ui.values[ 0 ] + " -  &#36;" + ui.values[ 1 ] );
              }
              ,stop: function(event, ui) { 
                  // update query on deductible range
                  currentpage = 0; 
          ...
          // update the html for the slider value before its changes  
          $( "#annualMaxDentalAmount" ).val( "$" + $( "#annualMaxDentalSlider" ).slider( "values", 0 ) + " - $" + $( "#annualMaxDentalSlider" ).slider( "values", 1 ) );
