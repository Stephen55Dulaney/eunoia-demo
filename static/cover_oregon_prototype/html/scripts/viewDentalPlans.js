       ...
       var products = [                     
                     ...
                     ,{"id":"12","annualmax":1000,"premium":140,"image":"images/heart_bkgr-01.png","sm_image":"images/heart_sm-01.png","planName":"Bay","hospital":"50","deductible":50,"copay":15,"carrier":"ABC Corp","plantype":"PPO"} 
	...
	$.each(products, function(i, object) {   
        ...
        $.each(pageProducts, function(i, object) {  
            ...
            setpremiumRange(parseFloat(object.premium)); 
                ...
                cell += '<a class="button utilityButton" href="SHOP_dental_plan_details.html&#63;planid&#61;'+object.id+'">View Details</a>';
                cell += '<\/div>'
                cell += '<\/td>'; 
